...
Original file is located at
    https://colab.research.google.com/drive/1bt2CJ_8FL-Sp4a0_REB1OhmZoGbY8GbQ
"""
...
X = df.drop(['Winner'], axis=1)  # Wszystkie cechy, z wyjątkiem kolumny 'Winner', są cechami wejściowymi
y = df['Winner']
...
replay=sc2reader.load_replay('/content/20240412 - Game 3 - BattleB vs Clem - TvT - Site Delta.SC2Replay')
